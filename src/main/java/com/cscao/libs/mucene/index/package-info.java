 ...
 * </h3>
 * <p>
 * {@link com.cscao.libs.mucene.index.Fields} is the initial entry point into the
 ...
 * </h3>
 * <p>
 * {@link com.cscao.libs.mucene.index.Terms} represents the collection of terms
 ...
 * }
 * </pre>
 * {@link com.cscao.libs.mucene.index.TermsEnum} provides an iterator over the list
 ...
 * </h3>
 * <p>
 *   {@link com.cscao.libs.mucene.index.PostingsEnum} is an extension of
 *   {@link com.cscao.libs.mucene.search.DocIdSetIterator}that iterates over the list of
 ...
 * </h3>
 *     <ul>
 *        <li>{@link com.cscao.libs.mucene.index.TermsEnum#docFreq}: Returns the number of
 ...
 *        <li>{@link com.cscao.libs.mucene.index.TermsEnum#totalTermFreq}: Returns the number
 ...
 *            from the index 
 *            ({@link com.cscao.libs.mucene.index.IndexOptions#DOCS DOCS})
 ...
 * </h3>
 *     <ul>
 *        <li>{@link com.cscao.libs.mucene.index.Terms#size}: Returns the number of
 *            unique terms in the field. This statistic may be unavailable 
 *            (returns <code>-1</code>) for some Terms implementations such as
 *            {@link com.cscao.libs.mucene.index.MultiTerms}, where it cannot be efficiently
 ...
 *        <li>{@link com.cscao.libs.mucene.index.Terms#getDocCount}: Returns the number of
 ...
 *        <li>{@link com.cscao.libs.mucene.index.Terms#getSumDocFreq}: Returns the number of
 *            postings (term-document mappings in the inverted index) for the field. This
 *            can be thought of as the sum of {@link com.cscao.libs.mucene.index.TermsEnum#docFreq}
 *            across all terms in the field, and like docFreq() it will also count postings
 *            that appear in deleted documents.
 *        <li>{@link com.cscao.libs.mucene.index.Terms#getSumTotalTermFreq}: Returns the number
 *            of tokens for the field. This can be thought of as the sum of 
 *            {@link com.cscao.libs.mucene.index.TermsEnum#totalTermFreq} across all terms in the
 ...
 * </h3>
 *     <ul>
 *        <li>{@link com.cscao.libs.mucene.index.IndexReader#maxDoc}: Returns the number of
 *            documents (including deleted documents) in the index. 
 *        <li>{@link com.cscao.libs.mucene.index.IndexReader#numDocs}: Returns the number
 *            of live documents (excluding deleted documents) in the index.
 *        <li>{@link com.cscao.libs.mucene.index.IndexReader#numDeletedDocs}: Returns the
 *            number of deleted documents in the index.
 *        <li>{@link com.cscao.libs.mucene.index.Fields#size}: Returns the number of indexed
 *            fields.
 *     </ul>
 ...
 * a {@link com.cscao.libs.mucene.search.similarities.Similarity} implementation will store some
 * of these values (possibly in a lossy way), into the normalization value for the document in
 * its {@link com.cscao.libs.mucene.search.similarities.Similarity#computeNorm} method.
 *     <ul>
 *        <li>{@link com.cscao.libs.mucene.index.FieldInvertState#getLength}: Returns the number of
 *            tokens for this field in the document. Note that this is just the number
 *            of times that {@link com.cscao.libs.mucene.analysis.TokenStream#incrementToken} returned
 *            true, and is unrelated to the values in 
 *            {@link com.cscao.libs.mucene.analysis.tokenattributes.PositionIncrementAttribute}.
 *        <li>{@link com.cscao.libs.mucene.index.FieldInvertState#getNumOverlap}: Returns the number
 ...
 *            such as synonyms.
 *        <li>{@link com.cscao.libs.mucene.index.FieldInvertState#getPosition}: Returns the accumulated
 *            position value for this field in the document: computed from the values of
 *            {@link com.cscao.libs.mucene.analysis.tokenattributes.PositionIncrementAttribute} and including
 *            {@link com.cscao.libs.mucene.analysis.Analyzer#getPositionIncrementGap}s across multivalued
 *            fields.
 *        <li>{@link com.cscao.libs.mucene.index.FieldInvertState#getOffset}: Returns the total
 *            character offset value for this field in the document: computed from the values of
 *            {@link com.cscao.libs.mucene.analysis.tokenattributes.OffsetAttribute} returned by
 *            {@link com.cscao.libs.mucene.analysis.TokenStream#end}, and including
 *            {@link com.cscao.libs.mucene.analysis.Analyzer#getOffsetGap}s across multivalued
 *            fields.
 *        <li>{@link com.cscao.libs.mucene.index.FieldInvertState#getUniqueTermCount}: Returns the number
 *            of unique terms encountered for this field in the document.
 *        <li>{@link com.cscao.libs.mucene.index.FieldInvertState#getMaxTermFrequency}: Returns the maximum
 ...
 * accessed via {@link com.cscao.libs.mucene.index.LeafReader#getNumericDocValues}.
 */
