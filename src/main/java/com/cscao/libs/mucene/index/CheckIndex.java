...
import com.cscao.libs.mucene.document.DocumentStoredFieldVisitor;
import com.cscao.libs.mucene.index.CheckIndex.Status.DocValuesStatus;
import com.cscao.libs.mucene.index.PointValues.IntersectVisitor;
import com.cscao.libs.mucene.index.PointValues.Relation;
import com.cscao.libs.mucene.search.DocIdSetIterator;
import com.cscao.libs.mucene.search.LeafFieldComparator;
import com.cscao.libs.mucene.search.Sort;
import com.cscao.libs.mucene.search.SortField;
...
import com.cscao.libs.mucene.store.Lock;
...
import com.cscao.libs.mucene.util.BytesRefBuilder;
import com.cscao.libs.mucene.util.CommandLineUtil;
import com.cscao.libs.mucene.util.FixedBitSet;
import com.cscao.libs.mucene.util.IOUtils;
import com.cscao.libs.mucene.util.LongBitSet;
import com.cscao.libs.mucene.util.StringHelper;
import com.cscao.libs.mucene.util.SuppressForbidden;
import com.cscao.libs.mucene.util.Version;
import com.cscao.libs.mucene.util.automaton.Automata;
import com.cscao.libs.mucene.util.automaton.CompiledAutomaton;

import static com.cscao.libs.mucene.search.DocIdSetIterator.NO_MORE_DOCS;
...
public final class CheckIndex implements Closeable {
  ...
  /** Command-line interface to check and exorcise corrupt segments from an index.
    ...
    Run it like this:
    <pre>
    java -ea:com.cscao.libs.mucene... com.cscao.libs.mucene.index.CheckIndex pathToIndex [-exorcise] [-verbose] [-segment X] [-segment Y]
    </pre>
    <ul>
  ...
  private static int doMain(String args[]) throws IOException, InterruptedException {
    ...
    if (!assertsOn())
      System.out.println("\nNOTE: testing will be more thorough if you run java with '-ea:com.cscao.libs.mucene...', so assertions are enabled");
  ...
  public static Options parseOptions(String[] args) {
    ...
    if (opts.indexPath == null) {
      throw new IllegalArgumentException("\nERROR: index path not specified" +
                         "\nUsage: java com.cscao.libs.mucene.index.CheckIndex pathToIndex [-exorcise] [-crossCheckTermVectors] [-segment X] [-segment Y] [-dir-impl X]\n" +
                         "\n" +
