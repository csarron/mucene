 ...
 */
package com.cscao.libs.mucene.codecs.compressing;


import static com.cscao.libs.mucene.codecs.compressing.CompressingStoredFieldsWriter.BYTE_ARR;
import static com.cscao.libs.mucene.codecs.compressing.CompressingStoredFieldsWriter.CODEC_SFX_DAT;
import static com.cscao.libs.mucene.codecs.compressing.CompressingStoredFieldsWriter.CODEC_SFX_IDX;
import static com.cscao.libs.mucene.codecs.compressing.CompressingStoredFieldsWriter.DAY;
import static com.cscao.libs.mucene.codecs.compressing.CompressingStoredFieldsWriter.DAY_ENCODING;
import static com.cscao.libs.mucene.codecs.compressing.CompressingStoredFieldsWriter.FIELDS_EXTENSION;
import static com.cscao.libs.mucene.codecs.compressing.CompressingStoredFieldsWriter.FIELDS_INDEX_EXTENSION;
import static com.cscao.libs.mucene.codecs.compressing.CompressingStoredFieldsWriter.HOUR;
import static com.cscao.libs.mucene.codecs.compressing.CompressingStoredFieldsWriter.HOUR_ENCODING;
import static com.cscao.libs.mucene.codecs.compressing.CompressingStoredFieldsWriter.NUMERIC_DOUBLE;
import static com.cscao.libs.mucene.codecs.compressing.CompressingStoredFieldsWriter.NUMERIC_FLOAT;
import static com.cscao.libs.mucene.codecs.compressing.CompressingStoredFieldsWriter.NUMERIC_INT;
import static com.cscao.libs.mucene.codecs.compressing.CompressingStoredFieldsWriter.NUMERIC_LONG;
import static com.cscao.libs.mucene.codecs.compressing.CompressingStoredFieldsWriter.SECOND;
import static com.cscao.libs.mucene.codecs.compressing.CompressingStoredFieldsWriter.SECOND_ENCODING;
import static com.cscao.libs.mucene.codecs.compressing.CompressingStoredFieldsWriter.STRING;
import static com.cscao.libs.mucene.codecs.compressing.CompressingStoredFieldsWriter.TYPE_BITS;
import static com.cscao.libs.mucene.codecs.compressing.CompressingStoredFieldsWriter.TYPE_MASK;
import static com.cscao.libs.mucene.codecs.compressing.CompressingStoredFieldsWriter.VERSION_CURRENT;
import static com.cscao.libs.mucene.codecs.compressing.CompressingStoredFieldsWriter.VERSION_START;
...
import com.cscao.libs.mucene.codecs.CodecUtil;
import com.cscao.libs.mucene.codecs.StoredFieldsReader;
import com.cscao.libs.mucene.document.Document;
import com.cscao.libs.mucene.index.CorruptIndexException;
import com.cscao.libs.mucene.index.FieldInfo;
import com.cscao.libs.mucene.index.FieldInfos;
import com.cscao.libs.mucene.index.IndexFileNames;
import com.cscao.libs.mucene.index.SegmentInfo;
import com.cscao.libs.mucene.index.StoredFieldVisitor;
import com.cscao.libs.mucene.store.AlreadyClosedException;
import com.cscao.libs.mucene.store.ByteArrayDataInput;
import com.cscao.libs.mucene.store.ChecksumIndexInput;
import com.cscao.libs.mucene.store.DataInput;
import com.cscao.libs.mucene.store.Directory;
import com.cscao.libs.mucene.store.IOContext;
import com.cscao.libs.mucene.store.IndexInput;
import com.cscao.libs.mucene.util.Accountable;
import com.cscao.libs.mucene.util.Accountables;
import com.cscao.libs.mucene.util.ArrayUtil;
import com.cscao.libs.mucene.util.BitUtil;
import com.cscao.libs.mucene.util.BytesRef;
import com.cscao.libs.mucene.util.IOUtils;
import com.cscao.libs.mucene.util.IntsRef;
import com.cscao.libs.mucene.util.packed.PackedInts;
