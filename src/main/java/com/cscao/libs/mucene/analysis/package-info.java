...
/**
 * Text analysis. 
 * <p>API and code to convert text into indexable/searchable tokens.  Covers {@link com.cscao.libs.mucene.analysis.Analyzer} and related classes.</p>
 ...
 * <ul>
 *   <li>
 *     {@link com.cscao.libs.mucene.analysis.Analyzer} &ndash; An <code>Analyzer</code> is
 *     responsible for supplying a
 *     {@link com.cscao.libs.mucene.analysis.TokenStream} which can be consumed
 *     by the indexing and searching processes.  See below for more information
 *     on implementing your own {@link com.cscao.libs.mucene.analysis.Analyzer}. Most of the time, you can use
 *     an anonymous subclass of {@link com.cscao.libs.mucene.analysis.Analyzer}.
 *   </li>
 *   <li>
 *     {@link com.cscao.libs.mucene.analysis.CharFilter} &ndash; <code>CharFilter</code> extends
 ...
 *     that are not the same as those in the original text. {@link com.cscao.libs.mucene.analysis.Tokenizer#setReader(java.io.Reader)}
 *     accept <code>CharFilter</code>s.  <code>CharFilter</code>s may
 *     be chained to perform multiple pre-tokenization modifications.
 *   </li>
 *   <li>
 *     {@link com.cscao.libs.mucene.analysis.Tokenizer} &ndash; A <code>Tokenizer</code> is a
 *     {@link com.cscao.libs.mucene.analysis.TokenStream} and is responsible for
 *     breaking up incoming text into tokens. In many cases, an {@link com.cscao.libs.mucene.analysis.Analyzer} will
 *     use a {@link com.cscao.libs.mucene.analysis.Tokenizer} as the first step in the analysis process.  However,
 *     to modify text prior to tokenization, use a {@link com.cscao.libs.mucene.analysis.CharFilter} subclass (see
 *     above).
 *   </li>
 *   <li>
 *     {@link com.cscao.libs.mucene.analysis.TokenFilter} &ndash; A <code>TokenFilter</code> is
 *     a {@link com.cscao.libs.mucene.analysis.TokenStream} and is responsible
 ...
 * <p>
 *   The relationship between {@link com.cscao.libs.mucene.analysis.Analyzer} and
 *   {@link com.cscao.libs.mucene.analysis.CharFilter}s,
 *   {@link com.cscao.libs.mucene.analysis.Tokenizer}s,
 *   and {@link com.cscao.libs.mucene.analysis.TokenFilter}s is sometimes confusing. To ease
 *   this confusion, here is some clarifications:
 * </p>
 * <ul>
 *   <li>
 *     The {@link com.cscao.libs.mucene.analysis.Analyzer} is a
 ...
 *     to produce {@link com.cscao.libs.mucene.analysis.TokenStream}s that accept a
 *     reader and produces tokens, and to wrap or otherwise
 *     pre-process {@link java.io.Reader} objects.
 *   </li>
 *   <li>
 *   The {@link com.cscao.libs.mucene.analysis.CharFilter} is a subclass of
 *  {@link java.io.Reader} that supports offset tracking.
 *   </li>
 *   <li>The{@link com.cscao.libs.mucene.analysis.Tokenizer}
 *     is only responsible for <u>breaking</u> the input text into tokens.
 *   </li>
 *   <li>The{@link com.cscao.libs.mucene.analysis.TokenFilter} modifies a
 *   stream of tokens and their contents.
 *   </li>
 *   <li>
 *     {@link com.cscao.libs.mucene.analysis.Tokenizer} is a {@link com.cscao.libs.mucene.analysis.TokenStream},
 *     but {@link com.cscao.libs.mucene.analysis.Analyzer} is not.
 *   </li>
 *   <li>
 *     {@link com.cscao.libs.mucene.analysis.Analyzer} is "field aware", but
 *     {@link com.cscao.libs.mucene.analysis.Tokenizer} is not. {@link com.cscao.libs.mucene.analysis.Analyzer}s may
 *     take a field name into account when constructing the {@link com.cscao.libs.mucene.analysis.TokenStream}.
 *   </li>
 * </ul>
 * <p>
 ...
 *   create an anonymous subclass of {@link com.cscao.libs.mucene.analysis.Analyzer}, provide {@link
 *   com.cscao.libs.mucene.analysis.Analyzer#createComponents(String)} and perhaps also
 *   {@link com.cscao.libs.mucene.analysis.Analyzer#initReader(String,
 *   java.io.Reader)}. However, if you need the same set of components
 *   over and over in many places, you can make a subclass of
 *   {@link com.cscao.libs.mucene.analysis.Analyzer}. In fact, Apache Lucene
 ...
 *  {@link com.cscao.libs.mucene.document.Field}s.  The PerFieldAnalyzerWrapper can be used to associate a different <code>Analyzer</code> with different
 *  {@link com.cscao.libs.mucene.document.Field}s. There is a great deal of
 ...
 *     {@link com.cscao.libs.mucene.index.IndexWriter#addDocument(Iterable) addDocument(doc)},
 ...
 *         // Use {@link com.cscao.libs.mucene.util.AttributeSource#reflectAsString(boolean)}
 ...
 * <p>
 *   Creating your own Analyzer is straightforward. Your Analyzer should subclass {@link com.cscao.libs.mucene.analysis.Analyzer}. It can use
 ...
 * <p>
 *   When {@link com.cscao.libs.mucene.document.Document#add(com.cscao.libs.mucene.index.IndexableField) document.add(field)}
 *   is called multiple times for the same field name, we could say that each such call creates a new 
 *   section for that field in that document. 
 *   In fact, a separate call to 
 *   {@link com.cscao.libs.mucene.analysis.Analyzer#tokenStream(String, java.io.Reader) tokenStream(field,reader)}
 ...
 *   {@link com.cscao.libs.mucene.analysis.Analyzer#getPositionIncrementGap(String) Analyzer.getPositionIncrementGap(fieldName)}:
 * </p>
 * <PRE class="prettyprint">
 *   Version matchVersion = Version.LUCENE_XY; // Substitute desired Lucene version for XY
 ...
 * <p>
 *    At the ends of each field, Lucene will call the {@link com.cscao.libs.mucene.analysis.TokenStream#end()}.
 ...
 * </p>
 * <p>
 *    The base method{@link com.cscao.libs.mucene.analysis.TokenStream#end()} sets PositionIncrement to 0, which is required.
 ...
 *    {@link com.cscao.libs.mucene.analysis.tokenattributes.PositionIncrementAttribute#getPositionIncrement() position increment} of all tokens to be one.
 ...
 *    {@link com.cscao.libs.mucene.analysis.tokenattributes.PositionLengthAttribute#getPositionLength() position length} of one.
 ...
 *   com.cscao.libs.mucene.util.AttributeSource#clearAttributes()} in
 *   incrementToken().</li>
 *   <li>Tokenizers must override {@link
 *   com.cscao.libs.mucene.analysis.TokenStream#end()}, and pass the final
 *   offset (the total number of input characters processed) to both
 *   parameters of {@link com.cscao.libs.mucene.analysis.tokenattributes.OffsetAttribute#setOffset(int, int)}.</li>
 * </ul>
 * <p>
 ...
 *   <li>When they add tokens, token filters should call {@link com.cscao.libs.mucene.util.AttributeSource#clearAttributes()} first.</li>
 ...
 * <p>
 *   Classes {@link com.cscao.libs.mucene.util.Attribute} and
 *   {@link com.cscao.libs.mucene.util.AttributeSource} serve as the basis upon which
 ...
 *   {@link com.cscao.libs.mucene.analysis.tokenattributes.CharTermAttribute}
 *   contains the term text of a token, and 
 *   {@link com.cscao.libs.mucene.analysis.tokenattributes.OffsetAttribute} contains
 ...
 *   <tr>
 *     <td>{@link com.cscao.libs.mucene.analysis.tokenattributes.CharTermAttribute}</td>
 *     <td>
 ...
 *   </tr>
 *   <tr>
 *     <td>{@link com.cscao.libs.mucene.analysis.tokenattributes.OffsetAttribute}</td>
 *     <td>The start and end offset of a token in characters.</td>
 *   </tr>
 *   <tr>
 *     <td>{@link com.cscao.libs.mucene.analysis.tokenattributes.PositionIncrementAttribute}</td>
 *     <td>See above for detailed information about position increment.</td>
 *   </tr>
 *   <tr>
 *     <td>{@link com.cscao.libs.mucene.analysis.tokenattributes.PositionLengthAttribute}</td>
 *     <td>The number of positions occupied by a token.</td>
 *   </tr>
 *   <tr>
 *     <td>{@link com.cscao.libs.mucene.analysis.tokenattributes.PayloadAttribute}</td>
 *     <td>The payload that a Token can optionally have.</td>
 *   </tr>
 *   <tr>
 *     <td>{@link com.cscao.libs.mucene.analysis.tokenattributes.TypeAttribute}</td>
 *     <td>The type of the token. Default is 'word'.</td>
 *   </tr>
 *   <tr>
 *     <td>{@link com.cscao.libs.mucene.analysis.tokenattributes.FlagsAttribute}</td>
 *     <td>Optional flags a token can have.</td>
 *   </tr>
 *   <tr>
 *     <td>{@link com.cscao.libs.mucene.analysis.tokenattributes.KeywordAttribute}</td>
 *     <td>
 ...
 * opposite. {@link com.cscao.libs.mucene.analysis.Analyzer} applies a reuse
 * strategy to the tokenizer and the token filters. It will reuse
 * them. For each new input, it calls {@link com.cscao.libs.mucene.analysis.Tokenizer#setReader(java.io.Reader)}
 * to set the input. Your components must be prepared for this scenario,
 * as described below.
 * <h4>Tokenizer</h4>
 * <ul>
 *   <li>
 *   You should create your tokenizer class by extending {@link com.cscao.libs.mucene.analysis.Tokenizer}.
 *   </li>
 *   <li>
 *   Your tokenizer <strong>must</strong> override {@link com.cscao.libs.mucene.analysis.TokenStream#end()}.
 ...
 *   </li>
 *   <li>
 *   If your tokenizer overrides {@link com.cscao.libs.mucene.analysis.TokenStream#reset()}
 *   or {@link com.cscao.libs.mucene.analysis.TokenStream#close()}, it
 *   <strong>must</strong> call the corresponding superclass method.
 *   </li>
 * </ul>
 * <h4>Token Filter</h4>
 *   You should create your token filter class by extending {@link com.cscao.libs.mucene.analysis.TokenFilter}.
 *   If your token filter overrides {@link com.cscao.libs.mucene.analysis.TokenStream#reset()},
 *   {@link com.cscao.libs.mucene.analysis.TokenStream#end()}
 *   or {@link com.cscao.libs.mucene.analysis.TokenStream#close()}, it
 *   <strong>must</strong> call the corresponding superclass method.
 * <h4>Creating delegates</h4>
 *   Forwarding classes (those which extend {@link com.cscao.libs.mucene.analysis.Tokenizer} but delegate
 *   selected logic to another tokenizer) must also set the reader to the delegate in the overridden
 *   {@link com.cscao.libs.mucene.analysis.Tokenizer#reset()} method, e.g.:
 *   <pre class="prettyprint">
 ...
 *   {@link com.cscao.libs.mucene.util.AttributeFactory}. The factory accepts an Attribute interface as argument
 ...
 *   {@link com.cscao.libs.mucene.util.AttributeImpl}:
 * </p>
 * <pre class="prettyprint">
 ...
 * text.
 * <p>
 * {@link com.cscao.libs.mucene.analysis.CharFilter} is designed to allow you to pre-process input like a FilterReader would, but also
 ...
 * </pre>
 */
package com.cscao.libs.mucene.analysis;
