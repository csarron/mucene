...
import com.cscao.libs.mucene.index.IndexReader;  // for javadoc
import com.cscao.libs.mucene.index.IndexableField;
import com.cscao.libs.mucene.search.IndexSearcher;  // for javadoc
import com.cscao.libs.mucene.search.ScoreDoc; // for javadoc
import com.cscao.libs.mucene.util.BytesRef;

/** Documents are the unit of indexing and search.
 *
 * A Document is a set of fields.  Each field has a name and a textual value.
 * A field may be {@link com.cscao.libs.mucene.index.IndexableFieldType#stored() stored} with the document, in which
 * case it is returned with search hits on the document.  Thus each document
 * should typically contain one or more stored fields which uniquely identify
 * it.
 *
 * <p>Note that fields which are <i>not</i> {@link com.cscao.libs.mucene.index.IndexableFieldType#stored() stored} are
