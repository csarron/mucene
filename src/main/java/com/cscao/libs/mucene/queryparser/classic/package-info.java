 ...
 * Sorry.
 * <p>Note that because JavaCC defines a class named <tt>Token</tt>, <tt>com.cscao.libs.mucene.analysis.Token</tt>
 * must always be fully qualified in source code in this package.
 *
 * <p><b>NOTE</b>: {@link com.cscao.libs.mucene.queryparser.flexible.standard} has an alternative queryparser that matches the syntax of this one, but is more modular,
 ...
 * syntax is documented in the {@link com.cscao.libs.mucene.util.automaton.RegExp RegExp} class. For example to find documents containing "moat" or "boat":
 * 
