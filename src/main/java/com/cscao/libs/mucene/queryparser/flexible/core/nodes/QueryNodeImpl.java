...
import com.cscao.libs.mucene.queryparser.flexible.messages.NLS;
...
public abstract class QueryNodeImpl implements QueryNode, Cloneable {
  ...
  public final void set(List<QueryNode> children) {
    ...
    if (isLeaf() || this.clauses == null) {
      ResourceBundle bundle = ResourceBundle
          .getBundle("com.cscao.libs.mucene.queryParser.messages.QueryParserMessages", Locale.getDefault());
  ...
  // #toQueryString(com.cscao.libs.mucene.queryParser.core.parser.EscapeQuerySyntax)}
