 ...
 * <h2>Query Nodes</h2>
 * <p>
 * The package <tt>com.cscao.libs.mucene.queryParser.nodes</tt> contains all the basic query nodes. The interface
 * that represents a query node is {@link com.cscao.libs.mucene.queryparser.flexible.core.nodes.QueryNode}.
 * <p>
 * {@link com.cscao.libs.mucene.queryparser.flexible.core.nodes.QueryNode}s are used by the text parser to create a syntax tree.
 * These nodes are designed to be used by UI or other text parsers.
 * The default Lucene text parser is {@link com.cscao.libs.mucene.queryparser.flexible.standard.parser.StandardSyntaxParser},
 * it implements Lucene's standard syntax.
 * <p>
 * {@link com.cscao.libs.mucene.queryparser.flexible.core.nodes.QueryNode} interface should be implemented by all query nodes,
 * the class {@link com.cscao.libs.mucene.queryparser.flexible.core.nodes.QueryNodeImpl} implements {@link com.cscao.libs.mucene.queryparser.flexible.core.nodes.QueryNode} and is extended
 ...
 * <li>PathQueryNode - {@link com.cscao.libs.mucene.queryparser.flexible.core.nodes.QueryNode} object used with path-like queries</li>
 ...
 * </ul>
 */
package com.cscao.libs.mucene.queryparser.flexible.core.nodes;
