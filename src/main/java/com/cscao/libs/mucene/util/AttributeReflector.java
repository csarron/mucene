...
public interface AttributeReflector {
   ...
   * E.g., an invocation of {@link com.cscao.libs.mucene.analysis.tokenattributes.CharTermAttributeImpl#reflectWith}
   * would call this method once using {@code com.cscao.libs.mucene.analysis.tokenattributes.CharTermAttribute.class}
