 ...
 *    <li>{@link com.cscao.libs.mucene.util.fst.Util#getByOutput Lookup-by-output} when the
 *        outputs are in sorted order (e.g., ordinals or file pointers)</li>
 *    <li>Pluggable {@link com.cscao.libs.mucene.util.fst.Outputs Outputs} representation</li>
 *    <li>{@link com.cscao.libs.mucene.util.fst.Util#shortestPaths N-shortest-paths} search by
 *        weight</li>
 *    <li>Enumerators ({@link com.cscao.libs.mucene.util.fst.IntsRefFSTEnum IntsRef} and {@link com.cscao.libs.mucene.util.fst.BytesRefFSTEnum BytesRef}) that behave like {@link java.util.SortedMap SortedMap} iterators
 * </ul>
 * <p>
