 ...
 * <p>
 *     The main access point is the {@link com.cscao.libs.mucene.util.packed.PackedInts} factory.
 * 
 * <h3>In-memory structures</h3>
 * 
 * <ul>
 *     <li><b>{@link com.cscao.libs.mucene.util.packed.PackedInts.Mutable}</b><ul>
 ...
 *     </ul></li>
 *     <li><b>{@link com.cscao.libs.mucene.util.packed.GrowableWriter}</b><ul>
 ...
 *     </ul></li>
 *     <li><b>{@link com.cscao.libs.mucene.util.packed.PagedGrowableWriter}</b><ul>
 ...
 *     </ul></li>
 *     <li><b>{@link com.cscao.libs.mucene.util.packed.PackedLongValues#deltaPackedBuilder}</b><ul>
 ...
 *     </ul></li>
 *     <li><b>{@link com.cscao.libs.mucene.util.packed.PackedLongValues#packedBuilder}</b><ul>
 *         <li>Same as deltaPackedBuilder but assumes values are 0-based.</li>
 *     </ul></li>
 *     <li><b>{@link com.cscao.libs.mucene.util.packed.PackedLongValues#monotonicBuilder}</b><ul>
 ...
 * 
 * <ul>
 *     <li><b>{@link com.cscao.libs.mucene.util.packed.PackedInts.Writer}, {@link com.cscao.libs.mucene.util.packed.PackedInts.Reader}, {@link com.cscao.libs.mucene.util.packed.PackedInts.ReaderIterator}</b><ul>
 *         <li>Only supports positive longs.</li>
 *         <li>Requires the number of bits per value to be known in advance.</li>
 ...
 *     </ul></li>
 *     <li><b>{@link com.cscao.libs.mucene.util.packed.BlockPackedWriter}, {@link com.cscao.libs.mucene.util.packed.BlockPackedReader}, {@link com.cscao.libs.mucene.util.packed.BlockPackedReaderIterator}</b><ul>
 *         <li>Splits the stream into fixed-size blocks.</li>
 *         <li>Compression is good when values are close to each other.</li>
 *         <li>Can address up to 2B * blockSize values.</li>
 *     </ul></li>
 *     <li><b>{@link com.cscao.libs.mucene.util.packed.MonotonicBlockPackedWriter}, {@link com.cscao.libs.mucene.util.packed.MonotonicBlockPackedReader}</b><ul>
 ...
 *     </ul></li>
 *     <li><b>{@link com.cscao.libs.mucene.util.packed.PackedDataOutput}, {@link com.cscao.libs.mucene.util.packed.PackedDataInput}</b><ul>
 *         <li>Writes sequences of longs where each long can use any number of bits.</li>
 *     </ul></li>
 * </ul>
 */
package com.cscao.libs.mucene.util.packed;
