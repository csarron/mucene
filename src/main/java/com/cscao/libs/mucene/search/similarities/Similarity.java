...
import com.cscao.libs.mucene.index.FieldInvertState;
import com.cscao.libs.mucene.index.LeafReaderContext;
import com.cscao.libs.mucene.search.CollectionStatistics;
import com.cscao.libs.mucene.search.Explanation;
import com.cscao.libs.mucene.search.IndexSearcher;
import com.cscao.libs.mucene.search.PhraseQuery;
import com.cscao.libs.mucene.search.TermQuery;
import com.cscao.libs.mucene.search.TermStatistics;
import com.cscao.libs.mucene.search.spans.SpanQuery;
import com.cscao.libs.mucene.util.BytesRef;
import com.cscao.libs.mucene.util.SmallFloat;
 ...
 * be later accessible via {@link com.cscao.libs.mucene.index.LeafReader#getNormValues(String)}.  Lucene makes no assumption
 ...
 * at query-time with {@link com.cscao.libs.mucene.index.LeafReader#getNumericDocValues(String)}.
 * <p>
 ...
 * When {@link IndexSearcher#explain(com.cscao.libs.mucene.search.Query, int)} is called, queries consult the Similarity's DocScorer for an
 * explanation of how it computed its score. The query passes in a the document id and an explanation of how the frequency
 * was computed.
 *
 * @see com.cscao.libs.mucene.index.IndexWriterConfig#setSimilarity(Similarity)
