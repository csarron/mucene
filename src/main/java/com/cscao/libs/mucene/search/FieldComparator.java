...
public abstract class FieldComparator<T> {
   ...
   *  com.cscao.libs.mucene.index.LeafReader#getNumericDocValues} and sorts by ascending value */
   ...
   *  com.cscao.libs.mucene.index.LeafReader#getNumericDocValues(String)} and sorts by ascending value */
   ...
   *  returned by {@link com.cscao.libs.mucene.index.LeafReader#getSortedDocValues(String)}), and
