 ...
 * abstract class {@link com.cscao.libs.mucene.search.similarities.Similarity} serves
 ...
 * 
 * <p>{@link com.cscao.libs.mucene.search.similarities.ClassicSimilarity} is the original Lucene
 ...
 * information, see {@link com.cscao.libs.mucene.search.similarities.TFIDFSimilarity}.
 * 
 * <p>{@link com.cscao.libs.mucene.search.similarities.BM25Similarity} is an optimized
 * implementation of the successful Okapi BM25 model.
 * 
 * <p>{@link com.cscao.libs.mucene.search.similarities.SimilarityBase} provides a basic
 ...
 * {@link com.cscao.libs.mucene.search.similarities.SimilarityBase}:
 * 
 * <a name="framework"></a>
 * <ul>
 *   <li>Amati and Rijsbergen's {@linkplain com.cscao.libs.mucene.search.similarities.DFRSimilarity DFR} framework;</li>
 *   <li>Clinchant and Gaussier's {@linkplain com.cscao.libs.mucene.search.similarities.IBSimilarity Information-based models}
 *     for IR;</li>
 *   <li>The implementation of two {@linkplain com.cscao.libs.mucene.search.similarities.LMSimilarity language models} from
 *   Zhai and Lafferty's paper.</li>
 *   <li>{@linkplain com.cscao.libs.mucene.search.similarities.DFISimilarity Divergence from independence} models as described
 *   in "IRRA at TREC 2012" (Dinçer).
 *   <li>
 * </ul>
 * 
 * Since {@link com.cscao.libs.mucene.search.similarities.SimilarityBase} is not
 * optimized to the same extent as
 * {@link com.cscao.libs.mucene.search.similarities.ClassicSimilarity} and
 * {@link com.cscao.libs.mucene.search.similarities.BM25Similarity}, a difference in
 ...
 * 
 * <p>To change {@link com.cscao.libs.mucene.search.similarities.Similarity}, one must do so for both indexing and
 ...
 * 
 * <p>To make this change, implement your own {@link com.cscao.libs.mucene.search.similarities.Similarity} (likely
 *     you'll want to simply subclass an existing method, be it
 *     {@link com.cscao.libs.mucene.search.similarities.ClassicSimilarity} or a descendant of
 *     {@link com.cscao.libs.mucene.search.similarities.SimilarityBase}), and
 *     then register the new class by calling
 *     {@link com.cscao.libs.mucene.index.IndexWriterConfig#setSimilarity(Similarity)}
 *     before indexing and
 *     {@link com.cscao.libs.mucene.search.IndexSearcher#setSimilarity(Similarity)}
 *     before searching.
 * 
 * <h3>Extending {@linkplain com.cscao.libs.mucene.search.similarities.SimilarityBase}</h3>
 * <p>
 * The easiest way to quickly implement a new ranking method is to extend
 * {@link com.cscao.libs.mucene.search.similarities.SimilarityBase}, which provides
 * basic implementations for the low level . Subclasses are only required to
 * implement the {@link com.cscao.libs.mucene.search.similarities.SimilarityBase#score(BasicStats, float, float)}
 * and {@link com.cscao.libs.mucene.search.similarities.SimilarityBase#toString()}
 * methods.
 * 
 * <p>Another option is to extend one of the <a href="#framework">frameworks</a>
 * based on {@link com.cscao.libs.mucene.search.similarities.SimilarityBase}. These
 * Similarities are implemented modularly, e.g.
 * {@link com.cscao.libs.mucene.search.similarities.DFRSimilarity} delegates
 * computation of the three parts of its formula to the classes
 * {@link com.cscao.libs.mucene.search.similarities.BasicModel},
 * {@link com.cscao.libs.mucene.search.similarities.AfterEffect} and
 * {@link com.cscao.libs.mucene.search.similarities.Normalization}. Instead of
 * subclassing the Similarity, one can simply introduce a new basic model and tell
 * {@link com.cscao.libs.mucene.search.similarities.DFRSimilarity} to use it.
 * 
 * <h3>Changing {@linkplain com.cscao.libs.mucene.search.similarities.ClassicSimilarity}</h3>
 * <p>
 ...
 *             <code>com.cscao.libs.mucene.misc</code> gives small
 ...
 *             {@link com.cscao.libs.mucene.search.similarities.Similarity#computeNorm(com.cscao.libs.mucene.index.FieldInvertState state)},
 *             it is possible to discount how the length of a field contributes
 *             to a score. In {@link com.cscao.libs.mucene.search.similarities.ClassicSimilarity},
 ...
 */
package com.cscao.libs.mucene.search.similarities;
