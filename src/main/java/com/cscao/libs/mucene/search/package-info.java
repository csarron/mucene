 ...
 * <h2>Search Basics</h2>
 * <p>
 * Lucene offers a wide variety of {@link com.cscao.libs.mucene.search.Query} implementations, most of which are in
 * this package, its subpackage ({@link com.cscao.libs.mucene.search.spans spans},
 ...
 * com.cscao.libs.mucene.search.IndexSearcher#search(Query,int)}.
 * <p>
 * Once a Query has been created and submitted to the {@link com.cscao.libs.mucene.search.IndexSearcher IndexSearcher}, the scoring
 * process begins. After some infrastructure setup, control finally passes to the {@link com.cscao.libs.mucene.search.Weight Weight}
 * implementation and its {@link com.cscao.libs.mucene.search.Scorer Scorer} or {@link com.cscao.libs.mucene.search.BulkScorer BulkScore}
 ...
 * <h2>Query Classes</h2>
 * <h3>
 *     {@link com.cscao.libs.mucene.search.TermQuery TermQuery}
 * </h3>
 * 
 * <p>Of the various implementations of
 *     {@link com.cscao.libs.mucene.search.Query Query}, the
 *     {@link com.cscao.libs.mucene.search.TermQuery TermQuery}
 *     is the easiest to understand and the most often used in applications. A
 *     {@link com.cscao.libs.mucene.search.TermQuery TermQuery} matches all the documents that contain the
 *     specified
 *     {@link com.cscao.libs.mucene.index.Term Term},
 *     which is a word that occurs in a certain
 *     {@link com.cscao.libs.mucene.document.Field Field}.
 *     Thus, a {@link com.cscao.libs.mucene.search.TermQuery TermQuery} identifies and scores all
 *     {@link com.cscao.libs.mucene.document.Document Document}s that have a
 *         {@link com.cscao.libs.mucene.document.Field Field} with the specified string in it.
 *     Constructing a {@link com.cscao.libs.mucene.search.TermQuery TermQuery}
 *     is as simple as:
 *     <pre class="prettyprint">
 *         TermQuery tq = new TermQuery(new Term("fieldName", "term"));
 *     </pre>In this example, the {@link com.cscao.libs.mucene.search.Query Query} identifies all
 *         {@link com.cscao.libs.mucene.document.Document Document}s that have the
 *         {@link com.cscao.libs.mucene.document.Field Field} named <tt>"fieldName"</tt>
 *     containing the word <tt>"term"</tt>.
 * <h3>
 *     {@link com.cscao.libs.mucene.search.BooleanQuery BooleanQuery}
 * </h3>
 * 
 * <p>Things start to get interesting when one combines multiple
 *     {@link com.cscao.libs.mucene.search.TermQuery TermQuery} instances into a
 *         {@link com.cscao.libs.mucene.search.BooleanQuery BooleanQuery}.
 *     A {@link com.cscao.libs.mucene.search.BooleanQuery BooleanQuery} contains multiple
 *     {@link com.cscao.libs.mucene.search.BooleanClause BooleanClause}s,
 *     where each clause contains a sub-query ({@link com.cscao.libs.mucene.search.Query Query}
 *     instance) and an operator (from 
 *         {@link com.cscao.libs.mucene.search.BooleanClause.Occur BooleanClause.Occur})
 *     describing how that sub-query is combined with the other clauses:
 *     <ol>
 * 
 *         <li><p>{@link com.cscao.libs.mucene.search.BooleanClause.Occur#SHOULD SHOULD} &mdash; Use this operator when a clause can occur in the result set, but is not required.
 ...
 * 
 *         <li><p>{@link com.cscao.libs.mucene.search.BooleanClause.Occur#MUST MUST} &mdash; Use this operator when a clause is required to occur in the result set. Every
 *             document in the result set will match
 *             all such clauses.</p></li>
 * 
 *         <li><p>{@link com.cscao.libs.mucene.search.BooleanClause.Occur#MUST_NOT MUST NOT} &mdash; Use this operator when a
 *             clause must not occur in the result set. No
 *             document in the result set will match
 *             any such clauses.</p></li>
 *     </ol>
 *     Boolean queries are constructed by adding two or more
 *     {@link com.cscao.libs.mucene.search.BooleanClause BooleanClause}
 *     instances. If too many clauses are added, a {@link com.cscao.libs.mucene.search.BooleanQuery.TooManyClauses TooManyClauses}
 *     exception will be thrown during searching. This most often occurs
 *     when a {@link com.cscao.libs.mucene.search.Query Query}
 *     is rewritten into a {@link com.cscao.libs.mucene.search.BooleanQuery BooleanQuery} with many
 *     {@link com.cscao.libs.mucene.search.TermQuery TermQuery} clauses,
 *     for example by {@link com.cscao.libs.mucene.search.WildcardQuery WildcardQuery}.
 *     The default setting for the maximum number
 *     of clauses 1024, but this can be changed via the
 *     static method {@link com.cscao.libs.mucene.search.BooleanQuery#setMaxClauseCount(int)}.
 * 
 * <h3>Phrases</h3>
 * 
 ...
 *     <ol>
 *         <li>
 *             <p>{@link com.cscao.libs.mucene.search.PhraseQuery PhraseQuery}
 *                 &mdash; Matches a sequence of
 *                 {@link com.cscao.libs.mucene.index.Term Term}s.
 *                 {@link com.cscao.libs.mucene.search.PhraseQuery PhraseQuery} uses a slop factor to determine
 ...
 *         </li>
 *         <li>
 *             <p>{@link com.cscao.libs.mucene.search.MultiPhraseQuery MultiPhraseQuery}
 ...
 *         </li>
 *         <li>
 *             <p>{@link com.cscao.libs.mucene.search.spans.SpanNearQuery SpanNearQuery}
 *                 &mdash; Matches a sequence of other
 *                 {@link com.cscao.libs.mucene.search.spans.SpanQuery SpanQuery}
 *                 instances. {@link com.cscao.libs.mucene.search.spans.SpanNearQuery SpanNearQuery} allows for
 *                 much more
 *                 complicated phrase queries since it is constructed from other 
 *                     {@link com.cscao.libs.mucene.search.spans.SpanQuery SpanQuery}
 *                 instances, instead of only {@link com.cscao.libs.mucene.search.TermQuery TermQuery}
 *                 instances.</p>
 *         </li>
 *     </ol>
 * 
 * <h3>
 *     {@link com.cscao.libs.mucene.search.TermRangeQuery TermRangeQuery}
 * </h3>
 * 
 * <p>The
 *     {@link com.cscao.libs.mucene.search.TermRangeQuery TermRangeQuery}
 ...
 *     and an upper
 *     {@link com.cscao.libs.mucene.index.Term Term}
 *     according to {@link com.cscao.libs.mucene.util.BytesRef#compareTo BytesRef.compareTo()}. It is not intended
 *     for numerical ranges; use {@link com.cscao.libs.mucene.search.PointRangeQuery PointRangeQuery} instead.
 * 
 *     For example, one could find all documents
 *     that have terms beginning with the letters <tt>a</tt> through <tt>c</tt>.
 * 
 * <h3>
 *     {@link com.cscao.libs.mucene.search.PointRangeQuery PointRangeQuery}
 * </h3>
 * 
 * <p>The
 *     {@link com.cscao.libs.mucene.search.PointRangeQuery PointRangeQuery}
 ...
 *     using a one of the numeric fields ({@link com.cscao.libs.mucene.document.IntPoint IntPoint},
 *     {@link com.cscao.libs.mucene.document.LongPoint LongPoint}, {@link com.cscao.libs.mucene.document.FloatPoint FloatPoint},
 *     or {@link com.cscao.libs.mucene.document.DoublePoint DoublePoint}).
 * 
 * <h3>
 *     {@link com.cscao.libs.mucene.search.PrefixQuery PrefixQuery},
 *     {@link com.cscao.libs.mucene.search.WildcardQuery WildcardQuery},
 *     {@link com.cscao.libs.mucene.search.RegexpQuery RegexpQuery}
 * </h3>
 * 
 * <p>While the
 *     {@link com.cscao.libs.mucene.search.PrefixQuery PrefixQuery}
 ...
 *     {@link com.cscao.libs.mucene.search.WildcardQuery WildcardQuery}.
 *     The {@link com.cscao.libs.mucene.search.PrefixQuery PrefixQuery} allows an application
 *     to identify all documents with terms that begin with a certain string. The 
 *         {@link com.cscao.libs.mucene.search.WildcardQuery WildcardQuery} generalizes this by allowing
 *     for the use of <tt>*</tt> (matches 0 or more characters) and <tt>?</tt> (matches exactly one character) wildcards.
 *     Note that the {@link com.cscao.libs.mucene.search.WildcardQuery WildcardQuery} can be quite slow. Also
 *     note that
 *     {@link com.cscao.libs.mucene.search.WildcardQuery WildcardQuery} should
 ...
 *     The {@link com.cscao.libs.mucene.search.RegexpQuery RegexpQuery} is even more general than WildcardQuery,
 *     allowing an application to identify all documents with terms that match a regular expression pattern.
 * <h3>
 *     {@link com.cscao.libs.mucene.search.FuzzyQuery FuzzyQuery}
 * </h3>
 *
 * <p>A
 *     {@link com.cscao.libs.mucene.search.FuzzyQuery FuzzyQuery}
 ...
 *    </ul>
 *    These models can be plugged in via the {@link com.cscao.libs.mucene.search.similarities Similarity API},
 ...
 *    change your {@link com.cscao.libs.mucene.search.similarities.Similarity Similarity}. Next, it will cover
 ...
 *    implementing your own {@link com.cscao.libs.mucene.search.Query Query} class and related functionality.
 ...
 *    {@link com.cscao.libs.mucene.search.IndexSearcher#explain(Query, int) IndexSearcher.explain(Query, doc)}
 ...
 * <p>In Lucene, the objects we are scoring are {@link com.cscao.libs.mucene.document.Document Document}s.
 *    A Document is a collection of {@link com.cscao.libs.mucene.document.Field Field}s.  Each Field has
 *    {@link com.cscao.libs.mucene.document.FieldType semantics} about how it is created and stored
 *    ({@link com.cscao.libs.mucene.document.FieldType#tokenized() tokenized},
 *    {@link com.cscao.libs.mucene.document.FieldType#stored() stored}, etc). It is important to note that
 ...
 *    {@link com.cscao.libs.mucene.search.BoostQuery}.</p>
 * 
 * <a name="changingScoring"></a>
 * <h2>Changing Scoring &mdash; Similarity</h2>
 * <p>
 * Changing {@link com.cscao.libs.mucene.search.similarities.Similarity Similarity} is an easy way to
 * influence scoring, this is done at index-time with 
 * {@link com.cscao.libs.mucene.index.IndexWriterConfig#setSimilarity(com.cscao.libs.mucene.search.similarities.Similarity)
 *  IndexWriterConfig.setSimilarity(Similarity)} and at query-time with
 * {@link com.cscao.libs.mucene.search.IndexSearcher#setSimilarity(com.cscao.libs.mucene.search.similarities.Similarity)
 ...
 * <p>
 * Finally, you can extend the low level {@link com.cscao.libs.mucene.search.similarities.Similarity Similarity} directly
 * to implement a new retrieval model, or to use external scoring factors particular to your application. For example,
 * a custom Similarity can access per-document values via {@link com.cscao.libs.mucene.index.NumericDocValues} and
 * integrate them into the score.
 * <p>
 * See the {@link com.cscao.libs.mucene.search.similarities} package documentation for information
 ...
 *     <ol>
 *         <li>
 *             {@link com.cscao.libs.mucene.search.Query Query} &mdash; The abstract object representation of the
 *             user's information need.</li>
 *         <li>
 *             {@link com.cscao.libs.mucene.search.Weight Weight} &mdash; The internal interface representation of
 ...
 *         <li>
 *             {@link com.cscao.libs.mucene.search.Scorer Scorer} &mdash; An abstract class containing common
 *             functionality for scoring. Provides both scoring and
 *             explanation capabilities.  This is created per-segment.</li>
 *         <li>
 *             {@link com.cscao.libs.mucene.search.BulkScorer BulkScorer} &mdash; An abstract class that scores
 *       a range of documents.  A default implementation simply iterates through the hits from
 *       {@link com.cscao.libs.mucene.search.Scorer Scorer}, but some queries such as
 *       {@link com.cscao.libs.mucene.search.BooleanQuery BooleanQuery} have more efficient
 *       implementations.</li>
 *     </ol>
 *     Details on each of these classes, and their children, can be found in the subsections below.
 * <h3>The Query Class</h3>
 *     <p>In some sense, the
 *         {@link com.cscao.libs.mucene.search.Query Query}
 ...
 *         {@link com.cscao.libs.mucene.search.Query Query} class has several methods that are important for
 *         derived classes:
 *         <ol>
 *             <li>{@link com.cscao.libs.mucene.search.Query#createWeight(IndexSearcher,boolean,float) createWeight(IndexSearcher searcher, boolean needsScores, float boost)} &mdash; A
 *                 {@link com.cscao.libs.mucene.search.Weight Weight} is the internal representation of the
 *                 Query, so each Query implementation must
 *                 provide an implementation of Weight. See the subsection on <a
 *                     href="#weightClass">The Weight Interface</a> below for details on implementing the Weight
 *                 interface.</li>
 *             <li>{@link com.cscao.libs.mucene.search.Query#rewrite(com.cscao.libs.mucene.index.IndexReader) rewrite(IndexReader reader)} &mdash; Rewrites queries into primitive queries. Primitive queries are:
 *                 {@link com.cscao.libs.mucene.search.TermQuery TermQuery},
 *                 {@link com.cscao.libs.mucene.search.BooleanQuery BooleanQuery}, <span
 *                     >and other queries that implement {@link com.cscao.libs.mucene.search.Query#createWeight(IndexSearcher,boolean,float) createWeight(IndexSearcher searcher,boolean needsScores, float boost)}</span></li>
 *         </ol>
 * <a name="weightClass"></a>
 * <h3>The Weight Interface</h3>
 *     <p>The
 *         {@link com.cscao.libs.mucene.search.Weight Weight}
 *         interface provides an internal representation of the Query so that it can be reused. Any
 *         {@link com.cscao.libs.mucene.search.IndexSearcher IndexSearcher}
 ...
 *         <ol>
 *             <li>
 *                 {@link com.cscao.libs.mucene.search.Weight#getQuery getQuery()} &mdash; Pointer to the
 *                 Query that this Weight represents.</li>
 *             <li>
 *                 {@link com.cscao.libs.mucene.search.Weight#scorer scorer()} &mdash;
 *                 Construct a new {@link com.cscao.libs.mucene.search.Scorer Scorer} for this Weight. See <a href="#scorerClass">The Scorer Class</a>
 *                 below for help defining a Scorer. As the name implies, the Scorer is responsible for doing the actual scoring of documents 
 *                 given the Query.
 *             </li>
 *             <li>
 *                 {@link com.cscao.libs.mucene.search.Weight#bulkScorer bulkScorer()} &mdash;
 *                 Construct a new {@link com.cscao.libs.mucene.search.BulkScorer BulkScorer} for this Weight. See <a href="#bulkScorerClass">The BulkScorer Class</a>
 *                 below for help defining a BulkScorer. This is an optional method, and most queries do not implement it.
 *             </li>
 *             <li>
 *                 {@link com.cscao.libs.mucene.search.Weight#explain(com.cscao.libs.mucene.index.LeafReaderContext, int)
 ...
 *                 that scores via a {@link com.cscao.libs.mucene.search.similarities.Similarity Similarity} will make use of the Similarity's implementation:
 *                 {@link com.cscao.libs.mucene.search.similarities.Similarity.SimScorer#explain(int, Explanation) SimScorer#explain(int doc, Explanation freq)}.
 *             </li>
 *         </ol>
 * <a name="scorerClass"></a>
 * <h3>The Scorer Class</h3>
 *     <p>The
 *         {@link com.cscao.libs.mucene.search.Scorer Scorer}
 *         abstract class provides common scoring functionality for all Scorer implementations and
 *         is the heart of the Lucene scoring process. The Scorer defines the following methods which
 *         must be implemented:
 *         <ol>
 *             <li>
 *                 {@link com.cscao.libs.mucene.search.Scorer#iterator iterator()} &mdash; Return a
 *                 {@link com.cscao.libs.mucene.search.DocIdSetIterator DocIdSetIterator} that can iterate over all
 *                 document that matches this Query.
 *             </li>
 *             <li>
 *                 {@link com.cscao.libs.mucene.search.Scorer#docID docID()} &mdash; Returns the id of the
 *                 {@link com.cscao.libs.mucene.document.Document Document} that contains the match.
 *             </li>
 *             <li>
 *                 {@link com.cscao.libs.mucene.search.Scorer#score score()} &mdash; Return the score of the
 *                 current document. This value can be determined in any appropriate way for an application. For instance, the
 *                 {@link com.cscao.libs.mucene.search.TermScorer TermScorer} simply defers to the configured Similarity:
 *                 {@link com.cscao.libs.mucene.search.similarities.Similarity.SimScorer#score(int, float) SimScorer.score(int doc, float freq)}.
 *             </li>
 *             <li>
 *                 {@link com.cscao.libs.mucene.search.Scorer#getChildren getChildren()} &mdash; Returns any child subscorers
 ...
 *     <p>The
 *         {@link com.cscao.libs.mucene.search.BulkScorer BulkScorer} scores a range of documents.  There is only one
 *         abstract method:
 *         <ol>
 *             <li>
 *                 {@link com.cscao.libs.mucene.search.BulkScorer#score(LeafCollector,com.cscao.libs.mucene.util.Bits,int,int) score(LeafCollector,Bits,int,int)} &mdash;
 ...
 * <p>In the typical search application, a {@link com.cscao.libs.mucene.search.Query Query}
 *    is passed to the {@link com.cscao.libs.mucene.search.IndexSearcher IndexSearcher},
 *    beginning the scoring process.
 * <p>Once inside the IndexSearcher, a {@link com.cscao.libs.mucene.search.Collector Collector}
 *    is used for the scoring and sorting of the search results.
 *    These important objects are involved in a search:
 *    <ol>                
 *       <li>The {@link com.cscao.libs.mucene.search.Weight Weight} object of the Query. The
 ...
 *       <li>A {@link com.cscao.libs.mucene.search.Sort Sort} object for specifying how to sort
 ...
 *    {@link com.cscao.libs.mucene.search.Weight Weight} object created by
 *    {@link com.cscao.libs.mucene.search.IndexSearcher#createNormalizedWeight(Query,boolean)
 *     IndexSearcher.createNormalizedWeight(Query,boolean)} and the number of results we want.
 *    This method returns a {@link com.cscao.libs.mucene.search.TopDocs TopDocs} object,
 *    which is an internal collection of search results. The IndexSearcher creates
 *    a {@link com.cscao.libs.mucene.search.TopScoreDocCollector TopScoreDocCollector} and
 *    passes it along with the Weight, Filter to another expert search method (for
 *    more on the {@link com.cscao.libs.mucene.search.Collector Collector} mechanism,
 *    see {@link com.cscao.libs.mucene.search.IndexSearcher IndexSearcher}). The TopScoreDocCollector
 *    uses a {@link com.cscao.libs.mucene.util.PriorityQueue PriorityQueue} to collect the
 *    top results for the search.
 * <p>If a Filter is being used, some initial setup is done to determine which docs to include. 
 *    Otherwise, we ask the Weight for a {@link com.cscao.libs.mucene.search.Scorer Scorer} for each
 *    {@link com.cscao.libs.mucene.index.IndexReader IndexReader} segment and proceed by calling
 *    {@link com.cscao.libs.mucene.search.BulkScorer#score(LeafCollector,com.cscao.libs.mucene.util.Bits) BulkScorer.score(LeafCollector,Bits)}.
 ...
 *    is where things get involved. The {@link com.cscao.libs.mucene.search.Scorer Scorer} that is returned
 *    by the {@link com.cscao.libs.mucene.search.Weight Weight} object depends on what type of Query was
 *    submitted. In most real world applications with multiple query terms, the 
 *    {@link com.cscao.libs.mucene.search.Scorer Scorer} is going to be a <code>BooleanScorer2</code> created
 *    from {@link com.cscao.libs.mucene.search.BooleanWeight BooleanWeight} (see the section on
 ...
 *   {@link com.cscao.libs.mucene.search.DocIdSetIterator#nextDoc DocIdSetIterator.nextDoc()} method. The nextDoc() method advances
 ...
 */
package com.cscao.libs.mucene.search;
