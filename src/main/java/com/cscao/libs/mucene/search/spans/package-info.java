 ...
 *    class {@link com.cscao.libs.mucene.search.spans.Spans Spans}.
 *  </p>
 * 
 ...
 * <ul>
 * 
 * <li>A {@link com.cscao.libs.mucene.search.spans.SpanTermQuery SpanTermQuery} matches all spans
 *    containing a particular {@link com.cscao.libs.mucene.index.Term Term}.
 *    This should not be used for terms that are indexed at position Integer.MAX_VALUE.
 * </li>
 * 
 * <li> A {@link com.cscao.libs.mucene.search.spans.SpanNearQuery SpanNearQuery} matches spans
 * which occur near one another, and can be used to implement things like
 * phrase search (when constructed from {@link com.cscao.libs.mucene.search.spans.SpanTermQuery}s)
 * and inter-phrase proximity (when constructed from other {@link com.cscao.libs.mucene.search.spans.SpanNearQuery}s).</li>
 *
 * <li> A {@link com.cscao.libs.mucene.search.spans.SpanWithinQuery SpanWithinQuery} matches spans
 * which occur inside of another spans. </li>
 *
 * <li> A {@link com.cscao.libs.mucene.search.spans.SpanContainingQuery SpanContainingQuery} matches spans
 * which contain another spans. </li>
 * 
 * <li>A {@link com.cscao.libs.mucene.search.spans.SpanOrQuery SpanOrQuery} merges spans from a
 * number of other {@link com.cscao.libs.mucene.search.spans.SpanQuery}s.</li>
 * 
 * <li>A {@link com.cscao.libs.mucene.search.spans.SpanNotQuery SpanNotQuery} removes spans
 * matching one {@link com.cscao.libs.mucene.search.spans.SpanQuery SpanQuery} which overlap (or comes
 * near) another.  This can be used, e.g., to implement within-paragraph
 * search.</li>
 * 
 * <li>A {@link com.cscao.libs.mucene.search.spans.SpanFirstQuery SpanFirstQuery} matches spans
 ...
 * 
 * <li>A {@link com.cscao.libs.mucene.search.spans.SpanPositionRangeQuery SpanPositionRangeQuery} is
 ...
 * </pre>
 */
package com.cscao.libs.mucene.search.spans;
