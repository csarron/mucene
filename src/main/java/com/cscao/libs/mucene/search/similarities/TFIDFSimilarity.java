 ...
 *      {@link com.cscao.libs.mucene.search.BoostQuery#BoostQuery(com.cscao.libs.mucene.search.Query, float) BoostQuery}.
 *      Notice that there is really no direct API for accessing a boost of one term in a multi term query,
 *      but rather multi terms are represented in a query as multi
 *      {@link com.cscao.libs.mucene.search.TermQuery TermQuery} objects,
 *      and so the boost of a term in the query is accessible by calling the sub-query
 *      {@link com.cscao.libs.mucene.search.BoostQuery#getBoost() getBoost()}.
 *      <br>&nbsp;<br>
 *    </li>
 *
 *    <li>
...
public abstract class TFIDFSimilarity extends Similarity {
   ...
   * {@link com.cscao.libs.mucene.index.IndexReader#numDocs() IndexReader#numDocs()} because also
